...
export default function Createlist({
  ...
  useEffect(() => {
    ...
    setRecord({
      ...
      recordId: data?._id,
      walkbooks: data?.walkBooks,
    });
    setWalkbooksLength(
      data?.walkBooks.length > 0 ? data?.walkBooks[0].voters : 50
    );
  ...
  return (
    <div>
      {console.log(selectedList, selectedListLength, selectedScript, data)}
      {/* <button
                        ...
                        {/* {saving === false && (
                          <button
                            ...
                            onClick={
                              // selectedList &&
                              // selectedScript &&
                              record.recordName !== "" && handleSaveRecord
                            }
                          >
                            Save
                          </button>
